...
public class CleanerController {
    ...
    @Operation(summary = "Download/view a photo from one of my assigned tasks")
    public ResponseEntity<Resource> downloadPhoto(@PathVariable UUID id, @PathVariable UUID photoId) {
        Resource resource = cleaningTaskService.loadMyPhotoResource(currentUserId(), id, photoId);
