...
public class MaintenanceController {
    ...
    @Operation(summary = "Download/view a photo from one of my assigned tickets")
    public ResponseEntity<Resource> downloadPhoto(@PathVariable UUID id, @PathVariable UUID photoId) {
        Resource resource = maintenanceTicketService.loadMyPhotoResource(currentUserId(), id, photoId);
