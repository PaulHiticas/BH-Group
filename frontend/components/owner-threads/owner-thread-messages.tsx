...
import type { OwnerThreadMessageResponse, OwnerThreadSenderType } from "@/lib/api/owner-threads"
...
/**
 * Same look and interaction as components/messaging/message-thread.tsx
 * (the per-reservation guest/staff thread), but typed for the separate
 * owner<->staff contact threads (OWNER/STAFF instead of GUEST/STAFF).
 */
export function OwnerThreadMessages({
  messages,
  isLoading,
  viewerType,
  onSend,
  ...
  messages: OwnerThreadMessageResponse[] | undefined
  isLoading: boolean
  viewerType: OwnerThreadSenderType
